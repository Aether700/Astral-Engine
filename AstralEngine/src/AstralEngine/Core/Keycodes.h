...
#define AE_KEY_KEY_PAD_0               320
#define AE_KEY_KEY_PAD_1               321
#define AE_KEY_KEY_PAD_2               322
#define AE_KEY_KEY_PAD_3               323
#define AE_KEY_KEY_PAD_4               324
#define AE_KEY_KEY_PAD_5               325
#define AE_KEY_KEY_PAD_6               326
#define AE_KEY_KEY_PAD_7               327
#define AE_KEY_KEY_PAD_8               328
#define AE_KEY_KEY_PAD_9               329
#define AE_KEY_KEY_PAD_DECIMAL         330
#define AE_KEY_KEY_PAD_DIVIDE          331
#define AE_KEY_KEY_PAD_MULTIPLY        332
#define AE_KEY_KEY_PAD_SUBTRACT        333
#define AE_KEY_KEY_PAD_ADD             334
#define AE_KEY_KEY_PAD_ENTER           335
#define AE_KEY_KEY_PAD_EQUAL           336
#define AE_KEY_LEFT_SHIFT              340
#define AE_KEY_LEFT_CONTROL            341
#define AE_KEY_LEFT_ALT                342
#define AE_KEY_LEFT_SYSTEM             343
#define AE_KEY_RIGHT_SHIFT             344
#define AE_KEY_RIGHT_CONTROL           345
#define AE_KEY_RIGHT_ALT               346
#define AE_KEY_RIGHT_SYSTEM            347
...
namespace AstralEngine
{
	enum class KeyCode
	{
		...
		KeyPad0 = AE_KEY_KEY_PAD_0,        
		KeyPad1 = AE_KEY_KEY_PAD_1,
		KeyPad2 = AE_KEY_KEY_PAD_2,
		KeyPad3 = AE_KEY_KEY_PAD_3,        
		KeyPad4 = AE_KEY_KEY_PAD_4,        
		KeyPad5 = AE_KEY_KEY_PAD_5,        
		KeyPad6 = AE_KEY_KEY_PAD_6,        
		KeyPad7 = AE_KEY_KEY_PAD_7,        
		KeyPad8 = AE_KEY_KEY_PAD_8,        
		KeyPad9 = AE_KEY_KEY_PAD_9,        
		
		KeyPadDecimal = AE_KEY_KEY_PAD_DECIMAL, 
		KeyPadDivide = AE_KEY_KEY_PAD_DIVIDE,   
		KeyPadMultiply = AE_KEY_KEY_PAD_MULTIPLY,
		KeyPadSubstract = AE_KEY_KEY_PAD_SUBTRACT,
		KeyPadAdd = AE_KEY_KEY_PAD_ADD,
		KeyPadEnter = AE_KEY_KEY_PAD_ENTER,    
		KeyPadEqual = AE_KEY_KEY_PAD_EQUAL,    
		
		LeftShift = AE_KEY_LEFT_SHIFT,  
		LeftCtrl = AE_KEY_LEFT_CONTROL,
		LeftAlt = AE_KEY_LEFT_ALT,    
		LeftSystem = AE_KEY_LEFT_SYSTEM,  
		RightShift = AE_KEY_RIGHT_SHIFT, 
		RightCtrl = AE_KEY_RIGHT_CONTROL,
		RightAlt = AE_KEY_RIGHT_ALT,  
		RightSystem = AE_KEY_RIGHT_SYSTEM,
		Menu = AE_KEY_MENU,        
...
{
	template<>
	struct hash<AstralEngine::KeyCode>
	{
		size_t operator()(const AstralEngine::KeyCode key) const
		{
			return (size_t)key;
		}
	};
